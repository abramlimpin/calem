    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                ...
                <p>
                    In Latin language, Calem means dove, which symbolizes for peace. It will be your security guard to be <strong>aware</strong>, to <strong>locate</strong> or even to <strong>evade</strong> the crimes happening nearby. 
                </p>
                 <p>
